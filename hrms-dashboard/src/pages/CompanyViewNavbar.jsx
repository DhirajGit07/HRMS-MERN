    ...
    <>
      ...
      <nav className="super-navbar">
        ...
        <div className="super-nav-icons">
          ...
          <Link to="/settingpage">
            <img src={settingIcon} alt="Settings" className="super-icon-button" />
          </Link>

          <img
            src={userProfile.profileImage}
            alt="Profile"
            className="super-profile-pic"
            onClick={() => {
