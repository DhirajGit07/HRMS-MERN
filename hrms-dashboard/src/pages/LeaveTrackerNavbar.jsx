...
axios.defaults.baseURL = 'http://localhost:5000'; // Change this as per your backend

const LeaveTrackerNavbar = ({ onLogout }) => {
    ...
    <>
     {isLoggingOut && (
      ...
      <nav className="all-navbar">
        <Link to="/leavesummary" className={`all-nav-links ${location.pathname === '/leavesummary' ? 'active' : ''}`}>
          Leave Tracker
        </Link>
        ...
        <div className="all-nav-icons">
          ...
          <Link to="/settingpage">
            <img src={settingIcon} alt="Settings" className="all-icon-button"  title='Setting' />
          </Link>
