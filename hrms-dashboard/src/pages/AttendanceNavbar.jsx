...
const AttendanceNavbar = ({ onLogout }) => {
  const [showQuickActions, setShowQuickActions] = useState(false);
  const [showSearchInput, setShowSearchInput] = useState(false);
  const [searchText, setSearchText] = useState('');
  const [showNotificationModal, setShowNotificationModal] = useState(false);
  const [showProfileModal, setShowProfileModal] = useState(false);  const [isLoggingOut, setIsLoggingOut] = useState(false);
    ...
    <>
     {isLoggingOut && (
      ...
      <div className="all-tabs">
        ...
        <Link to="/attendance-page" className={`all-tab ${location.pathname === '/attendance-page' ? 'active' : ''}`}>
